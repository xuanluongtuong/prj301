...
public class DepartmentAddServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DepartmentAddServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DepartmentAddServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            dp.setTenPB(tenpb);
            dp.setMaQL(Integer.parseInt(maql));
            dp.setDiaDiem(diaDiem);
            department.insertDepartment(dp);
            response.sendRedirect("depart");
        } catch (Exception e) {
