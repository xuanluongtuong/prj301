...
<html>
    ...
    <body>
        ...
        <div class="mymenu">
            <div class="mylist">
                <form action="departmentadd" method="post" style="display: inline; justify-content: center;">
                    <div class="form-container">
                        <div class="form-left">
                            <div class="form-group">
                                <label class="form-label" for="TENPB">Department Name</label>
                                <input class="form-input" type="text" id="TENPB" name="TENPB" required />
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="MAQL">Manager ID</label>
                                <input class="form-input" type="number" id="MAQL" name="MAQL" required />
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="DIADIEM">Location</label>
