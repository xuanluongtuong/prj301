...
INSERT INTO dbo.DU_AN(TENKH, TENDA, DIADIEM, NGANSACH, NGAYTHICONG, TRANGTHAI)
VALUES
    (N'Bùi Đức Thịnh', N'Nhà 167 Trương Định', N'167 Trương Định, Hai Bà Trưng, Hà Nội', 870, '2022-06-11', 1),
    (N'Lê Văn Phụng', N'Nhà 179 Trương Định', N'179 Đường Trương Định, Hai Bà Trưng, Hà Nội', 800, '2021-12-11', 1),
    (N'Nguyễn Thị Thúy', N'Nhà 47 Hòa Bình 4/Minh Khai', N'Ngách 47, Ngõ Hòa Bình 4, Hai Bà Trưng, Hà Nội', 830, '2021-06-11', 1),
    (N'Võ Thái Bắc', N'Nhà 112/5 Nghĩa Tân', N'Ngách 5, Ngõ 112, Đường Hoàng Quốc Việt, Phường Nghĩa Tân, Cầu Giấy, Hà Nội', 840, '2022-08-11', 1),
    (N'Đặng Đức Hoàng', N'Nhà 112/7 Nghĩa Tân', N'Ngách 7, Ngõ 112, Đường Hoàng Quốc Việt, Phường Nghĩa Tân, Cầu Giấy, Hà Nội', 820, '2021-12-11', 1),
    (N'Nguyễn Trung Kiên', N'Nhà 29/7 Phố Trạm', N'Ngách 7, Ngõ 29 Phố Trạm, Long Biên, Hà Nội', 850, '2021-03-11', 1),
    (N'Trịnh Quốc Toàn', N'Nhà 189 Nguyễn Văn Cừ', N'Ngõ 189, Đường Nguyễn Văn Cừ, Long Biên, Hà Nội', 890, '2022-02-11', 1),
    (N'Nguyễn Xuân Huy', N'Nhà 65P.Bằng Liệt', N'Ngõ 65 Phố Bằng Liệt, Hoàng Mai, Hà Nội', 950, '2022-01-11', 1),
    (N'Võ Văn Hoàng', N'Nhà 90 Cầu Bươu', N'90 Ngõ 2 Cầu Bươu, Thanh Trì, Hà Nội', 830, '2020-09-11', 1),
    (N'Hoàng Đình Sơn', N'Nhà 425 Phan Trọng Tuệ', N'425 Đường Phan Trọng Tuệ, Thị trấn Văn Điển, Thanh Trì, Hà Nội', 810, '2020-09-10', 1),
    (N'Công ty Misa', N'Văn phòng Misa', N'Tầng 1 + 2, Sàn thương mại N03 - T2 Khu Đoàn Ngoại Giao, Phường Xuân Tảo, Bắc Từ Liêm, Hà Nội', 890, '2020-11-11', 1),
    (N'Công ty Tofu', N'Văn phòng Tofu', N'Số 12 Nguyễn Thị Định, Phường Trung Hòa, Quận Cầu Giấy, Hà Nội', 900, '2022-03-14', 1),
    (N'Công ty VNG', N'Văn phòng VNG', N'165 Phố Thái Hà, Láng Hạ, Đống Đa, Hà Nội', 1000, '2020-01-11', 1),
    (N'Công ty Beeketing', N'Văn phòng Beeketing', N'Tầng 01 và Tầng 03 tòa NO CT2 – E4 Khu Đô Thị Mới Yên Hòa, Phường Yên Hòa, Cầu Giấy, Hà Nội', 920, '2021-11-11', 1),
    (N'Công ty Gameloft', N'Văn phòng Gameloft', N'Tầng 2 khối văn phòng, Toà nhà Tây Hà, 19 phố Tố Hữu, Phường Trung Văn, Nam Từ Liêm, Hà Nội', 950, '2020-06-03', 1),
    (N'Công ty CP Đầu tư xây dựng và Cơ điện IEC', N'Căn hộ chung cư IEC Complex', N'Đường Trần Thủ Độ, Tứ Hiệp, Thanh Trì, Hà Nội', 945, '2021-06-28', 1),
    (N'Tập đoàn Mường Thanh', N'Căn hộ chung cư Thanh Hà', N'Thanh Hà Cự khê Thanh oai, Hà Đông, Hà Nội', 990, '2022-02-11', 1),
    (N'Tập đoàn Vingroup', N'Căn hộ chung cư Vinhomes Smart City', N'TTTM Vincom Mega Mall Smart City, Tây Mỗ, Nam Từ Liêm, Hà Nội', 1000, '2020-11-30', 1),
    (N'Tập đoàn Phúc Hà', N'Căn hộ chung cư Thăng Long Victory', N'Lô đất HH1, Khu đô thị Nam An Khánh, Hoài Đức, Hà Nội', 960, '2020-01-10', 1),
    (N'Công ty cổ phần Sông Đà – Hoàng Long', N'Căn hộ chung cư The Golden An Khánh 18T1', N'Lô HH6, An Khánh, Hoài Đức, Hà Nội', 995, '2022-10-01', 1),
    (N'Công ty TNHH Lotte Center', N'Tòa nhà Lotte Center Hà Nội', N'54 Liễu Giai, Ba Đình, Hà Nội', 15000, '2020-08-21', 1),
    (N'Tập đoàn Vingroup', N'Tòa nhà Techno Park Tower', N'Vinhomes Ocean Park, Gia Lâm, Hà Nội', 17000, '2021-10-10', 1),
    (N'Tổng công ty Lâm nghiệp Việt Nam', N'Tòa chung cư Landmark 51', N'48 Vạn Phúc, Hà Đông, Hà Nội', 12000, '2020-02-17', 1),
    (N'Xí nghiệp Xây dựng Tư nhân số 1 Lai Châu', N'Khu Đô Thị Xala Hà Nội', N'Đường Lê Trọng Tấn, Phường Phúc La, Hà Đông, Hà Nội', 20000, '2017-01-01', 1),
    (N'Phan Thanh Tùng', N'Nhà Hàng Lẩu Phan Hà Nội', N'Ngách 3, 131 Phố Thái Hà, Đống Đa, Hà Nội', 10000, '2014-01-03', 1),
    (N'Phòng khám da liễu S-Beauty', N'Spa thẩm mĩ S Beauty Hà Nội', N'81 P. Trung Kính, P, Cầu Giấy, Hà Nội', 1000, '2013-01-20', 1),
    (N'Hội đồng pháp thuật tối cao', N'Nhà ga 9 3/4', N'Hà Nội', 10000, '2010-10-23', 1),
    (N'Hội đồng pháp thuật tối cao', N'Trụ sở Hội đồng phép thuật tại Việt Nam', N'Hà Nội', 10000, '2009-12-12', 1),
    (N'Hội đồng pháp thuật tối cao', N'Đại Học Hogwarts Việt Nam (Vietnamese Hogwarts University)', N'Hà Nội', 9000, '2011-03-19', 1);
